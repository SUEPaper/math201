...
2. 错误处理和快速修复
3. 在不更改功能性的情况下进行代码清理
4. 支持 Web 应用程序框架，例如 Django 和 Flask
5. 支持其他编程语言，例如 JavaScript、CoffeeScript、TypeScript、AngularJS 和 Node
6. 科学工具和库，例如 Matplotlib 和 NumPy
7. 能够在远程虚拟机上运行、调试、测试和部署应用程序
8. 查找代码中错误的调试程序，识别代码中性能问题的性能分析器，以及运行单元测试的测试运行器
9. 支持数据库
:::
